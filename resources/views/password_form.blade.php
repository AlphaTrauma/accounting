...
<body class="flex items-center justify-center h-[100vh]" style="background-size: cover; background-image: url(/images/graph1.png), linear-gradient(45deg, rgb(226, 226, 226), rgb(196, 196, 196))">
