        ...
        @if(isset($parent))
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ $parent['url'] }}" class="ms-1 text-lg font-medium text-gray-700 hover:text-teal-600 transition-color md:ms-2">{{ $parent['title'] }}</a>
                </div>
            </li>
        @endif
        ...
        @isset($title)
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-lg font-medium text-gray-500 md:ms-2">{{ $title }}</span>
                </div>
            </li>
        @endisset
        @if(isset($exception))
